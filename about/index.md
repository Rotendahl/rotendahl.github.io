...
| 1350 København K | [Github][githubProfile]
| Denmark  |  {{site.phone}} |
...
<!-- TODO add links -->
2017-2020 (expected)
:   **Masters, Computer Science** Data Science specialization
    [University of Copenhagen][dikuDK]
...
Work Experience
----------
**Data Scientist at Bolius: 2018-current** <br>
I've built an entire machine learning platform that maintains a list of data
related to houses, energyClass, comfort, radon levels, etc. This data is then
put into machine learning models and served through react projects that consume
the api exposed. This allows house owners to get extra information about their
house.

**Backend Developer at CMP: 2017-2018** <br>
I wrote backends for iPhone/Android apps in elixir and frontends in react native.


**Teaching assistant at University of Copenhagen: Feb 2017 - Juli 2017** <br>
...
--------------------
My work experience has mainly been in web development and machine learning.  
I am familiar with modern web practices such as graphQL, AJAX, REST, API's, etc.
For a list of some of the projects I made see either my [github][githubProfile]
or my [projects page][projectPage]. During my studies I have worked in a variety
of languages both imperative and functional.
...
[githubProfile]: https://github.com/rotendahl
[projectPage]: http://rotendahl.dk/projects/
<!-- check all below -->
