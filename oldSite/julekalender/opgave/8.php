...
<section class="book_section">
    ...
    <div class="row mt-50">
    	...
    	$vid = '<div class="col-md-6 col-sm-6">
				...
				<iframe width="400" height="280" src="https://www.youtube.com/embed/oKiA7Rm692g" frameborder="0" allowfullscreen></iframe>
			</div>
			<div class="col-md-6 col-sm-6">
					<h1>Snemandsspil</h1>
                    <p> Idag skal vi have snemanden til at løbe igennem verden
					så han kan komme væk fra de varme lande før han smelter.
                    </p>

					<p>Se videoen og hop ind på <a style="text-decoration: underline;" href="https://scratch.mit.edu/projects/133146075/#editor">scratch</a>
                    for at lave dit eget spil!</p>
			</div>
		</div>
		';
        $noVid = '<center><h1>Hov, den her låge er ikke åben endnu.</h1></center>';
