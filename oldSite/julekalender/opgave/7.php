...
<section class="book_section">
    ...
    <div class="row mt-50">
    	...
    	$vid = '<div class="col-md-6 col-sm-6">
				...
				<iframe width="400" height="280" src="https://www.youtube.com/embed/nG0HG02ZN0s" frameborder="0" allowfullscreen></iframe>
			</div>
			<div class="col-md-6 col-sm-6">
					<h1>Snemandsspil</h1>
                    <p> Så er det Benjamin der tager over og viser hvordan man
					laver en endless runner.
                    </p>
