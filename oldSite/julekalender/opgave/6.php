...
<section class="book_section">
    ...
    <div class="row mt-50">
    	...
    	$vid = '<div class="col-md-6 col-sm-6">
				...
				<iframe width="400" height="280" src="https://www.youtube.com/embed/pjr7EkeuPPY" frameborder="0" allowfullscreen></iframe>
			</div>
			<div class="col-md-6 col-sm-6">
					<h1>Dagens opgave</h1>
                    <p> Så skal <em>Gave eller Kul</em> spillet gøres færdigt.
                    </p>

					<p>Se videoen og hop ind på <a style="text-decoration: underline;" href="https://scratch.mit.edu/projects/132938059/#editor">scratch</a>
                    for at lave dit eget spil!</p>

					<p> Kig med i morgen og vær med til at lave et nyt spil</p>
			</div>
		</div>
		';
