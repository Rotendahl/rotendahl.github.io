...
<section class="book_section">
    ...
    <div class="row mt-50">
    	...
    	$vid = '<div class="col-md-6 col-sm-6">
				...
				<iframe width="400" height="280" src="https://www.youtube.com/embed/_5S-wJVtNo4" frameborder="0" allowfullscreen></iframe>
			</div>
			<div class="col-md-6 col-sm-6">
					<h1>Dagens opgave</h1>
                    <p> Simon viser hvordan næste del af spillet skal laves.
                    </p>

					<p>Se videoen og hop ind på <a style="text-decoration: underline;" href="https://scratch.mit.edu/projects/132941011/#editor">scratch</a>
