...
<section class="book_section">
    ...
    <div class="row mt-50">
    	...
    	$vid = '<div class="col-md-6 col-sm-6">
				...
				<iframe width="400" height="280" src="https://www.youtube.com/embed/vW4iLZEYntk" frameborder="0" allowfullscreen></iframe>
			</div>
			<div class="col-md-6 col-sm-6">
					<h1>Snemandsspil</h1>
                    <p> Nu skal spillet gøres færdigt, du kan prøve om du kan slå
					highscoren i videoen.
                    </p>

					<p>Se videoen og hop ind på <a style="text-decoration: underline;" href="https://scratch.mit.edu/projects/133150193/#editor">scratch</a>
